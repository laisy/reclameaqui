class Reclamacao < ApplicationRecord
  ...
  validates :nome_empresa, presence: {message: "campo obrigatório"},  length: {minimum: 3, too_short: "%{count} caracteres é o minimo permitido ", maximum:20, too_long: "%{count} caracteres é o máximo permitido " }
end