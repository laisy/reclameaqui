...
class ReclamacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reclamacao" do
    assert_difference('Reclamacao.count') do
      post reclamacaos_url, params: { reclamacao: { cat_problema: @reclamacao.cat_problema, nome_empresa: @reclamacao.nome_empresa, texto: @reclamacao.texto, titulo: @reclamacao.titulo, usuario: @reclamacao.usuario } }
    end
  ...
  test "should update reclamacao" do
    patch reclamacao_url(@reclamacao), params: { reclamacao: { cat_problema: @reclamacao.cat_problema, nome_empresa: @reclamacao.nome_empresa, texto: @reclamacao.texto, titulo: @reclamacao.titulo, usuario: @reclamacao.usuario } }
